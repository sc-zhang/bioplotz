...
| **vmin**             | float                          | Yes      | nan          | only affect when **value_type** is **numeric**, if not set, the minimum value of **bed_data** would be use, otherwise, the value lower than vmin would be increased to vmin                                                                                                                                       |
| **vmax**             | float                          | Yes      | nan          | only affect when **value_type** is **numeric**, if not set, the maximum value of **bed_data** would be use, otherwise, the value greater than vmax would be decreased to vmax                                                                                                                                     |
